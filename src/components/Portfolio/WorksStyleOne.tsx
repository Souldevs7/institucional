            ...
            {this.state.display ? (
              ...
              >
                <div className="work-card">
                  <Image src="/images/works/work1.jpg" alt="image" />
                ...
                <div className="work-card">
                  <Image src="/images/works/work2.jpg" alt="image" />
                  <div className="content text-center">
                    <span>
                      <Link href="/portfolio">
                        <a>Web Design</a>
                ...
                <div className="work-card">
                  <Image src="/images/works/work3.jpg" alt="image" />
                ...
                <div className="work-card">
                  <Image src="/images/works/work4.jpg" alt="image" />
                ...
                <div className="work-card">
                  <Image src="/images/works/work5.jpg" alt="image" />
                ...
                <div className="work-card">
                  <Image src="/images/works/work6.jpg" alt="image" />
                ...
                <div className="work-card">
                  <Image src="/images/works/work7.jpg" alt="image" />
                ...
                <div className="work-card">
                  <Image src="/images/works/work8.jpg" alt="image" />
